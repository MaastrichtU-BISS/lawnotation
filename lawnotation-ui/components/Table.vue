    ...
    <div class="flex justify-end m-2" v-if="search">
      ...
      <div class="ml-2 block bg-white">
        <div class="relative">
          ...
          <input v-model="tabledata.search.query" type="text" class="rounded-md border-0 bg-gray-50 p-2 pl-10 text-sm w-80 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400" :placeholder="`Search for ${tabledata.search.column}`">
        </div>
      </div>
    </div>
