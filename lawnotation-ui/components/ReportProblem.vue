...
<template>
    ...
    <Button @click="openPopup($event)" label="Report problem" outlined class="bg-white fixed z-50 w-24 h-10 text-xs font-light text-primary-500 border border-primary-500 hover:scale-110 hover:bg-white">
        <template #icon>
