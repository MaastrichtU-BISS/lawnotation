        ...
        <div class="p-6 space-y-6">
          <div class="items-center justify-center">
            ...
            <div v-if="page == 2" id="export-step-2">
              ...
              <div v-if="modelValue.export_options.ann_guidelines" class="relative z-0 w-full mb-5 group">
...
const publish = async () => {
  ...
  if (props.modelValue.export_options.ann_guidelines && !props.modelValue.publication.guidelines_url) {
