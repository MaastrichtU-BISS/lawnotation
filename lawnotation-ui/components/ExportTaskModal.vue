        ...
        <div class="p-6 space-y-6">
          <div class="items-center justify-center">
            <div v-if="page == 1" id="export-step-1">
              ...
              <div class="flex justify-between my-5">
                <button type="button" :disabled="!(
                  ...
                  <svg v-if="downloadingExport" aria-hidden="true" role="status" class="inline ml-2 w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg v-else class="ml-2 w-3.5 h-3.5 white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 16 18">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div v-if="page == 2" id="export-step-2">
              ...
              <div class="relative z-0 w-full mb-5 group">
                <input v-model="publicationValues.task_description" type="text" name="task_description"
                  id="task_description"
                  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" " required />
              ...
              <div class="relative z-0 w-full mb-5 group">
                <input v-model="publicationValues.labels_description" type="text" name="labels_description"
...
const downloadingExport = ref<boolean>(false);
...
const publish = async () => {
  ...
  if(!publicationValues.value.author) {
