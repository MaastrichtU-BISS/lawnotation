    ...
    <div v-if="publication" class="dimmer-wrapper">
        ...
        <div class="dimmer-content">
            ...
            <div class="max-w-screen-lg mx-auto my-4">
                <div class="flex items-center justify-center">
                    <label class="relative inline-flex items-center cursor-pointer mb-5">
                        ...
                        <span :class="`text-${status ? 'green-600' : 'red-500'}`" class="ms-3 text-sm font-medium st">{{ status ? 'Published' : 'Unpublished' }}</span>
                    </label>
                </div>
                <div class="flex items-center justify-center">
                ...
                <div class="flex items-center justify-center">
                    <div class="pb-3 w-1/2">
                        <div class="relative z-0 w-full mb-5 group">
                            <input v-model="new_publication.guidelines_url" type="url" name="guidelines_url" id="guidelines_url"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " />
                ...
                <div class="flex items-center justify-center">
                    <div class="pb-3 w-1/2">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <textarea id="task_description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" v-model="new_publication.task_description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center">
                ...
                <div class="flex items-center justify-center">
                    <div class="pb-3 w-1/2">
                        <label for="labels_description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Labels description</label>
                        <div class="relative z-0 w-full mb-5 group">
                            <textarea id="labels_description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" v-model="new_publication.labels_description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center">
            ...
            <div class="text-center mb-5">
                <button class="base btn-primary" @click="editPublication" data-test="save-changes-button">Save Changes</button>
            </div>
        </div>
    </div>
</template>
