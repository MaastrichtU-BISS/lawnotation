      ...
      <div class="mt-8 mx-auto sm:w-full sm:max-w-sm bg-white px-6 py-6 shadow rounded-md">
        <div class="space-y-3">
          ...
          <div class="flex justify-between items-center">
            ...
            <svg @click="stage = 'EMAIL'; token = ''" class="w-4 h-4  cursor-pointer text-gray-600 hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
