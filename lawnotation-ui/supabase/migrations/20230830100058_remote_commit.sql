...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."documents" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."tasks" FOR DELETE TO "authenticated" USING (true);

CREATE POLICY "Enable delete for users for everone (TODO)" ON "public"."annotations" FOR DELETE USING (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."annotation_relations" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."labelsets" FOR INSERT TO "authenticated" WITH CHECK (true);
